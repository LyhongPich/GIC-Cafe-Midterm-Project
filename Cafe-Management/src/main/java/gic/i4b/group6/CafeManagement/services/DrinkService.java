...
public interface DrinkService {
    ...
    void setDrink(String dcode, String dname, String cName, Float price, String note, MultipartFile image);
    void editDrink(Integer id, String dcode, String dname, String cName, Float price, String note, MultipartFile image);
